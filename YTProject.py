...
icon = Image.open("C:\\Users\\91739\\OneDrive\\Documents\\Youtube Project\\Youtube_logo.png")
st.set_page_config(page_title= "Youtube Data Harvesting and Warehousing | By Jayaram S",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This app is created by *Jayaram S!*"""})
...
api_key = "AIzaSyAkzRuUMfJxttxq8FfKOH9cJb2qcQXmnYc" #"AIzaSyAkzRuUMfJxttxq8FfKOH9cJb2qcQXmnYc" 
...
if selected == "Home":
    # Title Image
    st.image("C:\\Users\\91739\\OneDrive\\Documents\\Youtube Project\\title.png")
    col1,col2 = st.columns(2,gap= 'medium')
    col1.markdown("## :blue[Domain] : Music Media")
